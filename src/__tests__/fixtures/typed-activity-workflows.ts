...
import { callActivity, makeTemporalWorkflow, sleepUntil } from "../../engine-sandbox.js";
...
export const effectTypedActivity = makeTemporalWorkflow(TypedActivityDemo, (payload) =>
  Effect.gen(function* () {
